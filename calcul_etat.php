...
$proposeur_cette_semaine = $json_current_semaine[0]->proposeur->id;
$is_proposeur = false;
...
$proposition_semaine = $json_current_semaine[0]->proposition_termine;
...
if(isset($_SESSION['user'])){//si l'utilisateur est connecté
  $votants = $json_current_semaine[0]->votants;
...
$etat_theme_non_propose = $json_current_semaine[0]->theme == "";
